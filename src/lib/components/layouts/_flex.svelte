...
<div class="flex flex-col flex-nowrap justify-center xl:flex-row xl:flex-wrap">
  <div
    class="flex-1 w-full max-w-screen-md order-first transition-all duration-[400ms] xl:delay-[600ms] ease-out transform mx-auto xl:mr-0">
  ...
  <div
    class="flex-1 w-full max-w-screen-md xl:order-last transition-all duration-[400ms] xl:delay-[600ms] ease-out transform mx-auto xl:mr-0">
